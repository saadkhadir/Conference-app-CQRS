...
public class ConferenceUpdatedEvent {
    ...
    public ConferenceUpdatedEvent() {}

    public ConferenceUpdatedEvent(String id, String titre, ConferenceType type, LocalDateTime date, int durationMinutes, int nbInscrits, double score) {
        this.id = id;
        this.titre = titre;
        this.type = type;
        this.date = date;
